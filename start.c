						...
						while(1)
						{
								...
								switch(t)
								{
									...
									case 2://delete
										...
										{
											if(strcmp(a1.username,a2.username)==0 && strcmp(a1.password,a2.password)==0)
											{
												printf("user found\n");
												lseek(fd1,-1*sizeof(data),SEEK_CUR);
												break;
									...
									case 3://modify
										...
										{
											if(strcmp(a1.username,a3.username)==0 && strcmp(a1.password,a3.password)==0)
											{
												printf("user found\n");
												lseek(fd1,-1*sizeof(data),SEEK_CUR);
									...
									case 5://view_all
										...
										while(read(fd1,&a1,sizeof(a1)))
										{
											printf("%s %s %s\n",a1.username,a1.password,a1.status);
										}
										break;
									case 6://exit
										exit(0);
